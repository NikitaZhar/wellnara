...
/**
 * Service for appointment booking and appointment lifecycle operations.
 */
@Service
public class AppointmentService {
    ...
    /**
     * Returns appointments that block provider calendar slots.
     *
     * @param provider provider who owns appointments
     * @return blocking appointments
     */
    ...
    /**
     * Checks whether existing appointment list conflicts with requested time interval.
     *
     * @param appointments appointments to check
    ...
    /**
     * Converts appointment to appointment view.
     *
     * @param appointment appointment to convert
     * @param zone target timezone
     * @return appointment view
     */
    private AppointmentView toAppointmentView(Appointment appointment, ZoneId zone) {
    ...
    /**
     * Validates that user has provider role.
     *
     * @param provider user to validate
     */
